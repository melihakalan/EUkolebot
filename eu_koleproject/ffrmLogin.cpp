...
{
	MessageBox(this->Handle,"Deneme surumu gecici olarak kapatilmistir. Lutfen deneme yapabilmek icin www.onlinehile.org adresinden belirli saatler arasi kullanimi ucretsiz olan kolebot - deneme kart uyeligini aliniz.","deneme",MB_ICONINFORMATION);
	return;
	/*
	if(!_CWinsock.GetState()){
		bool bStart = _CWinsock.StartWinsock();
